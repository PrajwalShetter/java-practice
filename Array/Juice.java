class Juice{
	...
	void save(String name){
		...
		System.out.println("Running save from juice");
		System.out.println("name arg :"+name);
		if(this.names != null){
			System.out.println("The arrray is not null, saving in juice");
		...
		if(name != null){
			...
			for(String temp : this.names){
				if(name == temp){
					...
					System.out.println("Juice is found");
					found = true;
					break;
				}
			...
			if(!found){
				System.out.println("The juice is not found");
			}
		}
		else{
