class SparkPlug{
	...
	void save(String name){
		...
		System.out.println("Running save from sparkplug");
		System.out.println("name arg :"+name);
		if(this.names != null){
			System.out.println("The arrray is not null, saving in sparkplug");
		...
		if(name != null){
			...
			for(String temp : this.names){
				if(name == temp){
					...
					System.out.println("SparkPlug is found");
					found = true;
					break;
				}
			...
			if(!found){
				System.out.println("The sparkplug is not found");
			}
		}
		else{
