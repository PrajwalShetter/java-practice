class Dynamo{
	...
	void save(String name){
		...
		System.out.println("Running save from dynamo");
		System.out.println("name arg :"+name);
		if(this.names != null){
			System.out.println("The arrray is not null, saving in dynamo");
		...
		if(name != null){
			...
			for(String temp : this.names){
				if(name == temp){
					...
					System.out.println("Dynamo is found");
					found = true;
					break;
				}
			...
			if(!found){
				System.out.println("The dynamo is not found");
			}
		}
		else{
