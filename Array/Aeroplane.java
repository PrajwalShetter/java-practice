class Aeroplane{
	...
	void save(String name){
		...
		System.out.println("Running save from aeroplane");
		System.out.println("name arg :"+name);
		if(this.names != null){
			System.out.println("The arrray is not null, saving in aeroplane");
		...
		if(name != null){
			...
			for(String temp : this.names){
				if(name == temp){
					...
					System.out.println("Aeroplane is found");
					found = true;
					break;
				}
			...
			if(!found){
				System.out.println("The aeroplane is not found");
			}
		}
		else{
