class Biometric{
	...
	void save(String name){
		...
		System.out.println("Running save from biometric");
		System.out.println("name arg :"+name);
		if(this.names != null){
			System.out.println("The arrray is not null, saving in biometric");
		...
		if(name != null){
			...
			for(String temp : this.names){
				if(name == temp){
					...
					System.out.println("Biometric is found");
					found = true;
					break;
				}
			...
			if(!found){
				System.out.println("The biometric is not found");
			}
		}
		else{
